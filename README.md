...
Reference-market selection supports direct and reversed USD quotes, BTC/XBT and DOGE/XDG currency aliases, and live USDT conversion pairs using existing Kraken/Binance data. Missing or inactive conversion markets remain unknown; stablecoins are not assumed to equal one dollar.
